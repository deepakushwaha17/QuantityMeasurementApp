...
public class QuantityMeasurementAppTest {
	...
	// Tests for Length Unit comparisons, conversions, additions
	@Test
	...
	//Tests for Weight Unit comparisons, conversions, additions
    ...
    @Test
    public void additionKilogramPlusKilogram() {
        Weight w1 = new Weight(1.0, WeightUnit.KILOGRAM);
    ...
    @Test
    public void additionKilogramPlusGram() {
        Weight w1 = new Weight(1.0, WeightUnit.KILOGRAM);
    ...
    @Test
    public void additionExplicitTargetUnit() {
        Weight w1 = new Weight(1.0, WeightUnit.KILOGRAM);
        Weight w2 = new Weight(1000.0, WeightUnit.GRAM);
