...
public class QuantityMeasurementApp {
	...
	public static void main(String[] args) {
		...
		System.out.println(demonstrateLengthAddition(length1, length2, Length.LengthUnit.YARDS));
		
		System.out.println(demonstrateLengthAddition(6.0, Length.LengthUnit.INCHES, 6.0, Length.LengthUnit.INCHES, Length.LengthUnit.INCHES));
	}
